# ------------------------------------------------------
# KILL SIG
const _GW_UPSERVERLOGS_SIG_EXT = ".up_serverlog_sig"
_up_serverlogs_sig_name() = string(_GW_UPSERVERLOGS_SIG_EXT)
_is_up_serverlogs_sig_name(fn) = _endswith(fn, _GW_UPSERVERLOGS_SIG_EXT)
