...
# ## ---------------------------------------------------------------
# const _GW_RTDATA_DIR = ".rtdat"
# _rtdata_file(taskid, name) = _localdir(_GW_RTDATA_DIR, string(taskid, ".", name))
...
# ## ---------------------------------------------------------------
# function _clear_rts()
#     _uprepo_rtdir = _repodir(_GW_UPREPO_RTDIR)
#     _uplocal_rtdir = _repodir(_GW_UPLOCAL_RTDIR)
#     _gwrm.(_uprepo_rtdir)
